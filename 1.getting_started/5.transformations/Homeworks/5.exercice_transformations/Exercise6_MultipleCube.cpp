/*
Esercizio: più cubi nella scena ma ogni 3 cubi assegna una rotazione diversa
*/
...
int main() {
    ...
    //Viene renderizzato quindi come elemento in primo piano quello che c'è ll'interno del buffer in quel momento
    glEnable(GL_DEPTH_TEST);

    //Leggiamo da file vertex shader e fragment shader
    Shader ourShader("transformation_es6.vs", "transformation_es6.fs");
