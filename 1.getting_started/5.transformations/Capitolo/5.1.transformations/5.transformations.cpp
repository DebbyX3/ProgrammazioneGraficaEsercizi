...
int main() {
    ...
    Shader ourShader("5.transformation.vs", "5.transformation.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //definisco la matrice di trasformazione come una matrice di identità
        glm::mat4 transform = glm::mat4(1.0f); //se uso solo questa riga il risultato rimane uguale perchè è una matrice identità
        ...
        //Rendiamo visibile la trasformazione allo shader dichiarandola nella memoria principale 
