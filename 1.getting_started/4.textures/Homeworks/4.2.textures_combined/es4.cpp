...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("4.texture.vs", "es4.texture.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //esercizio 4
        //change the argument of the interpolation function from user input (use GLFW_KEY_UP and GLF_KEY_DOWN) or from time (use glfwGetTime())
        float timeValue = glfwGetTime();
        float opacityValue = (sin(timeValue) / 2.0f) + 0.5f;
        ourShader.setFloat("opacityValue", opacityValue);
